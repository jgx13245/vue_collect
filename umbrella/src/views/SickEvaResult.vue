...
<script>
import Hyper from '../components/SickEvaDetail/DoctorSickEvaHyper'
import BloodFat from '../components/SickEvaDetail/DoctorSickEvaBloodFat'
import DoctorSickDia from '../components/SickEvaDetail/DoctorSickDia'
import DoctorSickHeartBlood from '../components/SickEvaDetail/DoctorSickHeartBlood'
import DoctorSickTarget from '../components/SickEvaDetail/DoctorSickTarget'
import DoctorSickCom from '../components/SickEvaDetail/DoctorSickCom'
import DoctorSickNow from '../components/SickEvaDetail/DoctorSickNow'
import DoctorSickHealthRecord from '../components/SickEvaDetail/DoctorSickHealthRecord'
import DoctorEvaResult from '../components/SickEvaDetail/DoctorEvaResult'
// import DoctorRecord from '../components/DoctorSickEvaDetail/DoctorRecord'
import { mapState } from 'vuex'
import { fetchSickPingGu } from '../assets/js/api'
export default {
  data() {
    return {
      // 高血压患者情况
  ...
  methods:{
    ...
    async n(openId) {
      const res = await fetchSickPingGu({openId})
      console.log(res,"患者自己获取评估的页面")
      ...
      this.resParams = Object.assign(res.data.obj.cvdResult, res.data.obj.ascvdResult )
      console.log(this.resParams,'获取值治疗方案值得地方')
